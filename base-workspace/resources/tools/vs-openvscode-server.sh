...
if [ $INSTALL_ONLY = 0 ] ; then
    ...
    /usr/local/bin/openvscode-server --port=$PORT --disable-telemetry --user-data-dir=$HOME/.config/Code/ --extensions-dir=$HOME/.vscode/extensions/ --without-connection-token $WORKSPACE_HOME/
    sleep 15
fi